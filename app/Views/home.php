...
<body>
	...
	<div id="app" class="app">
		...
		<div id="header" class="app-header navbar navbar-expand-lg p-0">
			<div class="container-xxl px-3 px-lg-5">
				...
				<a class="navbar-brand d-flex align-items-center position-relative me-auto" href="index.html">
					<img src="assets/img/logo.png" class="invert-dark" alt="" height="22">
					<span class="badge text-body text-opacity-75 fw-bold fs-10px position-absolute end-0 top-0 mt-n1 me-n4">Bs5</span>
				</a>
				...
				<div class="ms-3">
					<a href="login" class="btn btn-theme fw-bold rounded-pill px-3 py-2">Login <i class="fa fa-arrow-right ms-2 opacity-5"></i></a>
				</div>
			</div>
		</div>
		<!-- END #header -->
		...
		<!-- BEGIN #home -->
		<div id="home" class="py-5 position-relative bg-gray-900" data-bs-theme="dark" style="background-image: url(assets/img/landing/hero-cover.png); background-repeat: no-repeat; background-position: top left; background-size: auto 100%;">
			<!-- BEGIN container -->
			<div class="container-xxl p-3 p-lg-5">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<h1 class="display-6 fw-600 mb-2 mt-4">
								Built with <span class="text-theme">Studio</span> Template
							</h1>
							<div class="fs-18px text-body text-opacity-75 mb-4">
								Join thousands of users worldwide who rely on Studio Template <br>
								to kickstart their startups, enhance company projects, hone creative skills, <br>
							...
							<div class="mb-2">
								<a href="index.html" class="btn btn-lg btn-theme px-3">Discover Our Template <i class="fa fa-arrow-right ms-2 opacity-5"></i></a>
							</div>
				...
				<div class="position-absolute top-0 bottom-0 end-0 w-50 ps-5 overflow-hidden d-lg-block d-none">
					<img class="w-100 h-100 d-block position-relative object-fit-cover" alt="Studio" src="assets/img/landing/hero.jpg">
				</div>
			</div>
			<!-- END container -->
		</div>
		...
		<div id="about" class="py-5 bg-component">
			<div class="container-xxl p-3 p-lg-5 text-center">
				...
				<p class="fs-16px text-body text-opacity-50 mb-5">Studio Template crafts high-performance web applications for <br>developers, designers, and entrepreneurs, enabling effortless unleashing of creativity.</p>
				<div class="row text-start g-3 gx-lg-5 gy-lg-4">
					...
					<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
						...
						<div class="flex-1 ps-3">
							...
							<p class="mb-0">Modify layouts, colors, and more with ease. Studio Template offers unparalleled flexibility to adapt to your specific needs.</p>
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
							...
							<div class="card-body fs-13px p-25px d-flex flex-column">
								<div class="d-flex align-items-center">
									<div class="flex-1">
										...
										<div class="h2 fw-bold mb-0">$5 <small class="h6 text-body text-opacity-50">/month*</small></div>
									</div>
									<div>
								...
								<div class="mx-n2">
									<a href="#" class="btn btn-default btn-lg fs-16px w-100 font-monospace">Get Started <i class="fa fa-arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body fs-13px p-25px d-flex flex-column">
								<div class="d-flex align-items-center">
									<div class="flex-1">
										...
										<div class="h2 fw-bold mb-0">$10 <small class="h6 text-body text-opacity-50">/month*</small></div>
									</div>
									<div>
										<iconify-icon icon="solar:map-arrow-up-bold-duotone" class="display-6 text-gray-500"></iconify-icon>
									</div>
								</div>
								<hr class="my-3">
								<div class="mb-5 text-body text-opacity-75 flex-1">
							...
							<div class="card-body fs-14px p-25px h-100 d-flex flex-column">
								<div class="d-flex align-items-center">
									<div class="flex-1">
										...
										<div class="h1 fw-bold mb-0">$15 <small class="h6 text-body text-opacity-50">/month*</small></div>
									</div>
									<div>
								...
								<a href="#" class="btn btn-light btn-lg fs-16px w-100 text-black font-monospace">Get Started <i class="fa fa-arrow-right ms-3 opacity-5"></i></a>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-md-4 col-sm-6 py-xl-5">
							...
							<div class="card-body fs-13px p-25px d-flex flex-column">
								<div class="d-flex align-items-center">
									<div class="flex-1">
										...
										<div class="h2 fw-bold mb-0">$99 <small class="h6 text-body text-opacity-50">/month*</small></div>
									</div>
									<div>
								...
								<div class="mx-n2">
									<a href="#" class="btn btn-default btn-lg fs-15px w-100 font-monospace">Get Started <i class="fa fa-arrow-right"></i></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div id="blog" class="py-5 bg-component">
			<div class="container-xxl p-3 p-lg-5">
				<div class="text-center mb-5">
					<h1 class="mb-3 text-center">Hubungi Kami</h1>
					<p class="fs-16px text-body text-opacity-50 text-center mb-0">
						
					</p>
				</div>
				<div class="row g-3 g-xl-4 mb-5 justify-content-center">
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
							<div>
								<img src="assets/img/landing/kampus_madiun.jpeg" alt="" class="object-fit-cover h-200px w-100 d-block">
							</div>
							<div class="flex-1 p-3 pb-0">
								<div class="mb-2">
									<span class="bg-theme bg-opacity-15 text-theme px-2 py-1 rounded small fw-bold">Kampus Madiun</span>
								</div>
								<table>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-map-marker-alt"></i></td>
										<td>Jl. Imam Bonjol No.1 Kartoharjo, Kota Madiun</td>
									</tr>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-phone"></i></td>
										<td>(0351) 463310</td>
									</tr>
									<tr>
										<td valign="top"><i class="fa fa-lg fa-fw me-2 fa-envelope"></i></td>
										<td>murnajati@yahoo.com</td>
									</tr>
								</table>
								<hr>
								<center>
									<a href="" class="btn btn-theme btn-lg btn-block px-4 fs-15px"><i class="fas fa-lg fa-fw me-2 fa-map"></i> Lihat Lokasi Map</a>	
								</center>
								<br>
							</div>
							<div class="p-3 pt-0 text-body text-opacity-50"></div>
						</div>
					</div>
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
							<div>
								<img src="assets/img/landing/kampus_malang.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
							</div>
							<div class="flex-1 p-3 pb-0">
								<div class="mb-2">
									<span class="bg-theme bg-opacity-15 text-theme px-2 py-1 rounded small fw-bold">Kampus Malang</span>
								</div>
								<table>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-map-marker-alt"></i></td>
										<td>Jl. Argotunggal No. 1 Lawang, Kab. Malang</td>
									</tr>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-phone"></i></td>
										<td>(0341) 426013, 425019</td>
									</tr>
									<tr>
										<td valign="top"><i class="fa fa-lg fa-fw me-2 fa-envelope"></i></td>
										<td>murnajati@yahoo.com</td>
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
							<div>
								<img src="assets/img/landing/kampus_surabaya.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
							</div>
							<div class="flex-1 p-3 pb-0">
								<div class="mb-2">
									<span class="bg-theme bg-opacity-15 text-theme px-2 py-1 rounded small fw-bold">Kampus Surabaya</span>
								</div>
								<table>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-map-marker-alt"></i></td>
										<td>Jl. Bendul Merisi No.7, Jagir, Wonokromo, Kota Surabaya</td>
									</tr>
									<tr>
										<td valign="top"><i class="fas fa-lg fa-fw me-2 fa-phone"></i></td>
										<td>(031) 8416169</td>
		...
		<div id="contact" class="py-5">
			<div class="container-xl p-3 p-lg-5">
				...
				<div class="row gx-3 gx-lg-5">
					...
					<div class="col-lg-6">
						<form action="index.html" method="GET" name="form_contact_us">
			...
			<div class="container-xxl px-3 px-lg-5">
				<div class="row gx-lg-5 gx-3 gy-lg-4 gy-3">
					<div class="col-lg-3 col-md-6">
						<div class="mb-3"><img src="assets/img/logo.png" class="w-80px invert-dark" alt="Studio"></div>
						<p class="mb-4">
							Studio is your go-to solution for creating stunning, responsive, and high-performance web applications. Designed for developers, designers, and entrepreneurs, it provides the tools and flexibility needed to bring your creative visions to life.
						</p>
						<h5>Follow Us</h5>
						<div class="d-flex">
